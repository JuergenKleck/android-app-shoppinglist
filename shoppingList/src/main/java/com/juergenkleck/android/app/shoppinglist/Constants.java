...
public class Constants {
    ...
    public static final int SHOPPING_CART_LIST = -1;
    ...
    public static final String DEFAULT_CONFIG_TEXTSIZE = Integer.toString(14);

    public static final String INVENTORY_DEFAULT_NAME = "Default";
    public static final int INVENTORY_DEFAULT_ORDER = 0;

    public static final String CONFIG_TEXT_UNIT = "sp";
    public static final int CONFIG_TEXT_ADD = 10;
